...
/////// Diffuse:
                ...
                float3 diffuse = (directDiffuse + indirectDiffuse) * _node_1428.rgb;
/// Final Color:
...
/////// Diffuse:
                float NdotL = max(0.0,dot( normalDirection, lightDirection ));
                float3 directDiffuse = max( 0.0, NdotL) * attenColor;
                float3 diffuse = directDiffuse * _node_1428.rgb;
/// Final Color:
                float3 finalColor = diffuse;
